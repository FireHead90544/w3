---
title: "Transitioning from Django to Next.js: How and why I switched?"
summary: SEO Friendly Description
publish_date: 2024-09-13
---

Konnichiwa, Rudransh-desu! Welp, at this point I'm pretty sure you've tried stalking a bit too much about me and I'd say that's not a surprise to me. I'm indeed cool, heh. So, let's quickly skip the formalities. As you might know, I recently switched from django to Next.js completely (though I'm not really planning to demolish my last portfolio website at the moment, I'll probably archive it near future), I'd document all my insights, metrics and experiences.

# Me and my insanity

When it comes to tech, I'm really insane about trying out different tech and tools, just because I like implementing everything my own way. While you can find more about my insanity through my [works](/work), I'd stick to discussing about my portfolio website here.
...
Then, I defined the schema for my content using JSON-LD and finally I setted up the `sitemap.xml` and `robots.txt` dynamically and uploaded the `favicon.ico` and such stuff.
...
I used Google Page Speed Insights to continously test the performance of my new portfolio website while it was under development to optimize it as much as I could. Finally, I compared the metrics of my old portfolio written in django with the new one written with Next.js and here are the results:

#### **INSERT THE COMPARISION/INSIGHTS HERE**
